...
//  SleepKarma
//
//  Created by John Bogil on 2/12/21.
//
...
extension Date {
	...
	func minutesBetween(date1: Date, date2: Date) -> Int {
		...
		let newDateMinutes = date2.timeIntervalSinceReferenceDate/60
		let oldDateMinutes = date1.timeIntervalSinceReferenceDate/60

		//then return the difference
		let diff = Int(newDateMinutes - oldDateMinutes)
		return diff
...
//
//		let components = calendar.dateComponents([Calendar.Component.minute], from: date1, to: date2)
//
